...
<div class="navbar navbar-inverse navbar-static-top">
		<div class="container">
			...
			<ul class="nav navbar-nav navbar-left">
					<li><a href="/BookMyShow/" >BookMyShow</a></li>
					<li><a href="/BookMyShow/register.jsp" class="login reg" >Register</a></li>
			</ul>
		</div>
		...
		<div class="login-container" style="border: thin solid lightskyblue;border-radius: 25px;">
			<div class="login-card">
				<div class="login-form">
					<div id="login-box">
						<h5>
							<label class="control-label">Please fill in below details to Login.</label>
						</h5>
