...
<body>
	...
	<div class="w3_content_agilleinfo_inner">
		<div class="agile_featured_movies">
			<div class="inner-agile-w3l-part-head">
				<h3 class="w3l-inner-h-title">Hotel Transylvania 3</h3>
				<p class="w3ls_head_para">Animation, Adventure, Comedy</p>
			</div>
	...
	<div class="w3l-movie-gride-agile">
		<a href="" class="hvr-sweep-to-bottom"><img
			src="images/p4.jpg" title="BookMyShow" class="img-responsive" alt=" ">
			<div class="w3l-action-icon">
				<i class="fa fa-play-circle-o" aria-hidden="true"></i>
			</div> </a>
		<div class="mid-1 agileits_w3layouts_mid_1_home">
			<div class="w3l-movie-text">
				<h6>Hotel Transylvania 3</h6>
			</div>
	...
	<form action="bookingForm" method="post" name='bookingForm'
		id="bookingForm">
		<input id="movie" name="movie" type="hidden" value="Hotel Transylvania 3">
